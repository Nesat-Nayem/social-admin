...
export const _votersNames = ['Jack Carter', 'Jack Carter', 'Jack Carter', 'Jack Carter'];

// ----------------------------------------------------------------------

export const _votersLocations = ['Tami Nadu', 'Tami Nadu', 'Tami Nadu', 'Tami Nadu'];

// ----------------------------------------------------------------------

export const _votersRigions = ['BJP', 'AAM AAdMI PARTY', 'CPI', 'INC', 'NPP'];

// ----------------------------------------------------------------------

export const _votersAgeGroups = ['18-25', '25-45', '45-70', '70+', '18-25'];

// ----------------------------------------------------------------------

export const _votersVotingCount = ['1800', '20000', '5000', '5000'];

// ----------------------------------------------------------------------

export const _votersState = ['Tami Nadu', 'Tami Nadu', 'Tami Nadu', 'Tami Nadu', 'Tami Nadu'];

// ----------------------------------------------------------------------

export const _votersDistrict = ['Tami Nadu', 'Tami Nadu', 'Tami Nadu', 'Tami Nadu', 'Tami Nadu'];

// ----------------------------------------------------------------------

export const _votersConstituency = [
  'Tami Nadu',
  'Tami Nadu',
  'Tami Nadu',
  'Tami Nadu',
...
export const _votersTotalVoting = ['20000', '20000', '20000', '20000', '20000', '20000'];

// ----------------------------------------------------------------------

export const _votersVotingPerct = ['40%', '40%', '40%', '40%', '40%'];

// ----------------------------------------------------------------------

export const _votersImg = [
  'https://social.atpuae.com/images/congress.png',
  'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1c/Aam_Aadmi_Party_flag_%282%29.svg/75px-Aam_Aadmi_Party_flag_%282%29.svg.png',
  'https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/CPI-banner.svg/75px-CPI-banner.svg.png',
  'https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Indian_National_Congress_Flag.svg/75px-Indian_National_Congress_Flag.svg.png',
  'https://upload.wikimedia.org/wikipedia/commons/thumb/6/61/NPP_Flag.jpg/75px-NPP_Flag.jpg',
];

// ----------------------------------------------------------------------

export const _schemesTitle = [
  'भारत सरकार की नई पोर्टल जारी, अब सभी योजना का लाभ ऐसे मिलेगा',
  'भारत सरकार की नई पोर्टल जारी, अब सभी योजना का लाभ ऐसे मिलेगा',
  'भारत सरकार की नई पोर्टल जारी, अब सभी योजना का लाभ ऐसे मिलेगा',
  'भारत सरकार की नई पोर्टल जारी, अब सभी योजना का लाभ ऐसे मिलेगा',
  'भारत सरकार की नई पोर्टल जारी, अब सभी योजना का लाभ ऐसे मिलेगा',
...
export const _schemesPublished = [
  '01/10/2024',
  '01/10/2024',
  '01/10/2024',
  '01/10/2024',
