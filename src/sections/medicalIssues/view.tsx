...
import {
  IMedicalItem,
  IMedicalTableFilters,
  IMedicalTableFilterValue,
} from 'src/types/medical-issues';

import MedicalTableFiltersResult from './medical-table-filters-result';
import {
  RenderCellLike,
  RenderCellName,
  RenderCellShare,
...
} from './medical-table-row';

// ----------------------------------------------------------------------

const defaultFilters: IMedicalTableFilters = {
  services: [],
};
...
export default function MedicalIssueView() {
  ...
  const [tableData, setTableData] = useState<IMedicalItem[]>([]);
  ...
  const handleFilters = useCallback((name: string, value: IMedicalTableFilterValue) => {
  ...
  const handleViewRow = useCallback(
    (id: string) => {
      router.push(`${paths.dashboard.medicalIssues.details}/${id}`);
    },
    [router]
  );
...
function applyFilter({
  ...
  inputData: IMedicalItem[];
  filters: IMedicalTableFilters;
}) {
